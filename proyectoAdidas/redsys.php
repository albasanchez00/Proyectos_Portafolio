<?php
include_once "/proyectoAdidas/header.php";
?>
<section class="bloque-general">
    <picture class="bloque-img">
        <img class="img3" src="/proyectoAdidas/media/datos-operaciones.jpg" alt="">
    </picture>
    <section class="bloque-Form">
        <h1>Datos Bancanrios</h1>

        <form action="/proyectoAdidas/pagoRedsys.php" method="post">
            <p>
            ...
            <p class="btn-datos">
                <a class="btn-volver" href="/proyectoAdidas/tramitarPedido.php">Volver</a>
